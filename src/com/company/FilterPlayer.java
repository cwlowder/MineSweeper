...
public class FilterPlayer extends AbstractPlayer {
    ...
    static {
        ...
        filters.add(new Filter(
                ...
                FLAG.Two, FLAG.Cov, FLAG.Two,
                FLAG.One, FLAG.Min, FLAG.One
        ));
        filters.add(new Filter(
                FLAG.One, FLAG.One, FLAG.One, FLAG.One,
                FLAG.One, FLAG.Min, FLAG.Cov, FLAG.One,
                FLAG.One, FLAG.Two, FLAG.Min, FLAG.One,
                FLAG.Ign, FLAG.One, FLAG.One, FLAG.One
        ));
        filters.add(new Filter(
                FLAG.One, FLAG.Min, FLAG.One,
                FLAG.Two, FLAG.Cov, FLAG.Ign,
                FLAG.One, FLAG.Min, FLAG.Ign
        ));
        */
        filters.add(new Filter(
